...
class User < ActiveRecord::Base
	...
	has_attached_file :avatar, :styles => { :medium => "200x200>", :thumb => "48x48#", :small => "24x24#", :tiny => "16x16#" }, :url => "/:class/:attachment/:id/:style_:basename.:extension", :path => ":rails_root/public/:class/:attachment/:id/:style_:basename.:extension"
